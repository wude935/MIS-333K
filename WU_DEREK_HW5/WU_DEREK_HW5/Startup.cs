...
namespace WU_DEREK_HW5
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            String connectionString = "Server=tcp:fa20wuderekhw5.database.windows.net,1433;Initial Catalog=fa20wuderekhw5;Persist Security Info=False;User ID=misadmin;Password=password!1;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
