...
namespace WU_DEREK_HW4
{
    public class Startup
    {
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            String connectionString = "Server=tcp:fa20wuderekhw4.database.windows.net,1433;Initial Catalog=fa20hwderekhw4;Persist Security Info=False;User ID=MISAdmin;Password=password1!;MultipleActiveResultSets=True;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
